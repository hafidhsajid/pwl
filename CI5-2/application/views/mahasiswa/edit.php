            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <?php if ($mahasiswa['jeniskelamin'] == "Perempuan") : ?>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender" id="gender" value="Perempuan" checked>
                                    <label class="form-check-label" for="perempuan">
                                        Perempuan
                                    </label>
                                </div>
                            <?php elseif ($mahasiswa['jeniskelamin'] == "Laki-Laki") : ?>
                                <div class="form-check form-check-inline">
