    ...
    <br><br>
        ...
        <tbody>
            ...
            <tr>
                ...
                class="badge badge-danger float-right"
                onclick="return confirm('Data ini akan dihapus');">Hapus</a>
                <a href="<?= base_url(); ?>matkul/edit/<?= $mhs['id_matkul']; ?>" class="badge badge-success float-right">Edit</a>
                <a href="<?= base_url(); ?>matkul/detail/<?= $mhs['id_matkul']; ?>" class="badge badge-primary float-right">Detail</a>
            </td>
